// admin/src/app/features/timesheet/review-form/review-form.component.ts — icons: getIconPath ✅ (Phase 1 sweep)
...
export class ReviewComponent implements OnInit, AfterViewInit {
  ...
  readonly canEmployeeEdit = computed(() => {
    ...
    if (!ts) return false;
    const currentUserId = this.authService.getCurrentUserSync()?.cognitoId;
